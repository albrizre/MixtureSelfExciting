...
K = 1 # Choose number of change points

scenario="A"
for (sim in 1:100){

  load(paste0("Simulated_datasets/Sim_",sim,"_alpha_",alpha,"_force_",offspring_force,"_lambda_exp_",lambda_exp,"_",scenario,".rda"))
  ...
  inits <- function() list(lambda0 = constants$lambda0_base,
                           lambda0_Mech = constants$lambda0_base,
                           theta = 0,
                           phi = 50,
                           Mech = c(0,1),
                           Mech_const = c(0,1),
                           Mech_i = rep(1,constants$N),
                           aux = rep(1,constants$N),
  ...
  if (!file.exists(paste0("Simulated_Models/Sim_",sim,"_alpha_",alpha,"_force_",offspring_force,"_lambda_exp_",lambda_exp,"_",model_name,"_",K,"_",scenario,".rda"))){
      ...
      save(mcmc.output,file=paste0("Simulated_Models/Sim_",sim,"_alpha_",alpha,"_force_",offspring_force,"_lambda_exp_",lambda_exp,"_",model_name,"_",K,"_",scenario,".rda"))
    }
