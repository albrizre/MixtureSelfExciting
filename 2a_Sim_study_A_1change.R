...
for (sim in 1:100){
  ...
  load(paste0("Simulated_datasets/Sim_",sim,"_alpha_",alpha,"_force_",offspring_force,"_lambda_exp_",lambda_exp,"_A.rda"))
  ...
  if (!file.exists(paste0("Simulated_Models/Sim_",sim,"_alpha_",alpha,"_force_",offspring_force,"_lambda_exp_",lambda_exp,"_",model_name,"_",K,"_A.rda"))){
      ...
      save(mcmc.output,file=paste0("Simulated_Models/Sim_",sim,"_alpha_",alpha,"_force_",offspring_force,"_lambda_exp_",lambda_exp,"_",model_name,"_",K,"_A.rda"))
    }
